...
class JobVacancyIndex extends StatefulWidget {
  const JobVacancyIndex({super.key});

  @override
  State<JobVacancyIndex> createState() => _JobVacancyIndexState();
}

class _JobVacancyIndexState extends State<JobVacancyIndex> {
  ...
  Future<void> _fetchData({bool refresh = false}) async {
    try {
      ...
      final JobVacancyResponse response = await _service.getJobVacancies(
        page: _currentPage,
      );
