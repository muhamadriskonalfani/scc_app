...
class DashboardCareerInfo extends StatelessWidget {
  const DashboardCareerInfo({super.key});
              ...
              child: Column(
                children: [
                  _careerItem(
                    ...
                    onTap: () {
                      Navigator.pushNamed(context, AppRoutes.apprenticeship);
                    },
                  ),
                  _careerItem(
                    context,
                    ...
                    onTap: () {
                      Navigator.pushNamed(context, AppRoutes.jobVacancy);
                    },
                  ),
                ],
              ),
